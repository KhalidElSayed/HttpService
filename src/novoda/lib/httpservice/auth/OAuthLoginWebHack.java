...
/**
 * Web view which simulates a OAuth authorization.
 */
public abstract class OAuthLoginWebHack {
        ...
        view.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                if (loggedIn) {
                    ...
                    onJavascriptExecute(view, username, password);
                    loggedIn = true;
                }
    ...
    protected void onJavascriptExecute(WebView view, String username, String password) {
        view.loadUrl("javascript:document.getElementById(\"" + getLoginDOMID() + "\").value = '"
                + username + "'");
        view.loadUrl("javascript:document.getElementById(\"" + getPasswordDOMID() + "\").value = '"
                + password + "'");
        onPreSubmit(view);
        view.loadUrl("javascript:document.body.getElementsByTagName(\"form\")[" + getFormIndex()
                + "].submit()");
    }
