 ...
 * Plus has to deliver the events to handlers and processors. <br>
 * It is clear that the double responsibility of managing processors and
 * handlers can be a sign to do some refactoring.
 * 
...
public class EventBus implements HasHandlers, HasProcessors {
    ...
    /**
     * This method is called when there is an exception during the execution of
     * a request. It is propagating onThrowable down to handlers.
     * 
     * @param intentWrapper
     * @param t
     */
    ...
    /**
     * This method is called when the content of a request is received. It is
     * propagating onContentReceived down to handlers.
     * 
     * @param response
     */
    ...
    /**
     * This event is fired before the execution of a request. In this way a
     * processor can intercept the request before is made and execute some
     * logic.
     * 
     * @param intentWrapper
     * @param httpRequest
    ...
    /**
     * This event is fired after the execution of a request. In this way a
     * processor can intercept the request after is made and execute some logic
     * on the response.
     * 
     * @param uri
     * @param response
